...
We're almost there! First head back to your GitHub repository and click the "Settings" tab.
...
#### **Step 5.1:** Scroll down until you find the GitHub Pages settings section. GitHub Pages is currently disabled. To activate, first select the `main` branch from the dropdown.
...
If your URL still doesn't want to resolve, adding `index` after the backslash of your URL sometimes helps to expedite the process. Regardless, patience is often key and your web page will be up and running soon!
